...
function sdj_lnt_build_ticker(){
	...
	<div id="sdj_ticker_script_<?php echo $options['lnt_location'];?>"> 
		...
		<ul id="webticker">   
            ...
            <?php if($credit){ ?>
                <li>Created with <a href="http://www.latestnewsticker.com/?utm_source=wordpress-plugins&utm_medium=users-site&utm_campaign=in-ticker">Latest News Ticker</a> a Wordpress Plugin by <a href="http://www.shanejones.co.uk/?utm_source=wordpress-plugins&utm_medium=users-site&utm_campaign=lnt-in-ticker">Shane Jones</a></li>
            <?php } ?>
            </ul>
